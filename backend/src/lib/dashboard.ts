...
export const DASHBOARD_SEGMENTS = new Set([
  ...
  'cost',
  'privacy',
  'blog', // /blog and /blog/<slug> — static articles, built from frontend/content
  'faq', // the site-wide questions page, with FAQPage structured data
  ...
  */
  'favicon.ico',
  'icon.svg',
  // Generated by frontend/src/app/sitemap.ts and robots.ts. Same story as the
  // icon: root-level files a crawler asks this Worker for.
  'sitemap.xml',
  'robots.txt',
  // The plain-text index of the site for language models (llmstxt.org), and
  // its long form with every guide inlined. Generated by route handlers in
  // frontend/src/app, so the same story again.
  'llms.txt',
  'llms-full.txt',
  // The IndexNow key (frontend/public), which Bing and the other IndexNow
  // engines fetch to confirm a URL submission came from this site. It has to
  // sit at the root to cover every URL. See tools/indexnow.mjs.
